...
def make_labels(s): 
    i = 0 
    for word in l:   
        os.system("convert -fill black -background white -bordercolor white -border 4  -font /usr/share/fonts/truetype/windows-font/simhei.ttf -pointsize %d label:\"%s\" \"uka_%d_%d.png\""%(s,word,i,s/12-1)) 
        i = i + 1 
